...
public class FragBebidasACTInsertar extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.layout_frag_bebidas_act_insertar, container, false);
    }
    ...
    public void init_botones(){
        boton_regresar = (Button) getView().findViewById(R.id.button_regresar_ACT_insertar_FRAG_bebida);
